package com.efeiyi.association.taglib;
 ...
 * 分页列表（1,2,3...）
 */
public class PCPageList extends com.ming800.core.taglib.PCPageList {
    ...
    private String getPagesUrl(int index, int pageCount, StringBuilder pageHref) {
        ...
        if (pageCount <= DISPLAY_PAGES) {//总页数小于指定页数，则展示所有分页
            ...
            if (index - 1 <= distance) {//当前页距离首页近时，这之间不用省略号  呈现样式1234567...10 假设pageCount为10
                ...
                content.append("<li><a href=\"").append(pageHref).append(DISPLAY_PAGES + 1).append("\">").append("...</a></li>");
                ...
                content.append("<li><a href=\"").append(pageHref).append(pageCount - DISPLAY_PAGES).append("\">").append("...</a></li>");
                ...
                content.append("<li><a href=\"").append(pageHref).append(index - CENTER_PAGES).append("\">").append("...</a></li>");
    ...
    private String getNextPage(int index, int pageCount, StringBuilder pageHref) {
        ...
        if (nextIndex > pageCount) {
            return new String("<li class=\"am-disabled bigRound\"><a href=\"#\">&raquo;</a></li>");
        } else {
            return new StringBuilder("<li class=\"bigRound\"><a href=\"").append(pageHref).append(pageCount).append("\">&raquo;</a></li>").toString();
        }
    }
