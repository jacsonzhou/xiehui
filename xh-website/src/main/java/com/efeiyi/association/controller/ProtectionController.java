...
//                resultPage = "/pc/choiceness";
    ...
    public ModelAndView declare(HttpServletRequest request, ModelMap modelMap) throws Exception {
        ...
        List<Document> list = (List<Document>) xdoManager.list(tempDo, tempDoQuery, null);
...
//            modelMap.put("object2", list.get(1));
    ...
    @RequestMapping({"/protection.download.do"})
    public ModelAndView download(HttpServletRequest request,ModelMap model){

        return  new ModelAndView("/protection/download");
